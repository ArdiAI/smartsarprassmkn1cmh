...
import { Menu, X, Building2, Sun, Moon, Users, Calendar, Trophy, FileText, Users as OrgIcon, LogOut } from 'lucide-react';
...
export default function Navbar() {
  ...
  const moreLinks = [
    { label: 'Agenda Sekolah', path: '/agenda', icon: Calendar },
    { label: 'Organisasi', path: '/organizations', icon: OrgIcon },
    { label: 'Proposal', path: '/proposals', icon: FileText },
